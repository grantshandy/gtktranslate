...
uninstall:
	...
	rm -f /usr/share/icons/hicolor/16x16/apps/gtktranslate.png
	rm -f /usr/share/icons/hicolor/22x22/apps/gtktranslate.png
	rm -f /usr/share/icons/hicolor/24x24/apps/gtktranslate.png
	rm -f /usr/share/icons/hicolor/32x32/apps/gtktranslate.png
	rm -f /usr/share/icons/hicolor/48x48/apps/gtktranslate.png
	rm -f /usr/share/icons/hicolor/64x64/apps/gtktranslate.png
	rm -f /usr/share/icons/hicolor/96x96/apps/gtktranslate.png
	rm -f /usr/share/icons/hicolor/256x256/apps/gtktranslate.png
	rm -f /usr/share/icons/hicolor/512x512/apps/gtktranslate.png
